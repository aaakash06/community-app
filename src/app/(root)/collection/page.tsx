...
return (
    <>
      <div className="flex w-full  flex-col-reverse justify-between gap-5 sm:flex-row sm:items-center mb-10 max-sm:mx-auto">
        <h1 className="h1-bold text-dark100_light900 max-sm:text-[20px]">Saved Questions</h1>
        <div>
...
questions.length==0 ? <div className='mt-20'>
<ImageComponent></ImageComponent>
  
  <p className="mt-10 text-center text-xl poppins text-primary-500"> There is no saved question to show</p>
  </div> :  <div className="carts flex flex-col text-sm gap-10 mt-10 text-dark100_light900 ">
   {questions?.map((q) => {
