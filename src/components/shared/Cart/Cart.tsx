...
interface PropsType{
 ...
 const Cart = ({question}:PropsType) => {
  return (


  
    <div className="flex flex-col gap-5 p-7 background-light900_dark200 rounded-lg shadow-md ">
      <span className="sm:hidden">{getTimeAgo(question.createdAt)}</span>
          ...
          <div className="bottom flex justify-between">
            ...
            <span>{question.author.name} <span className="max-sm:hidden">- asked {getTimeAgo(question.createdAt)}</span> </span>
